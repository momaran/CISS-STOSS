...
# Simulación con cambio de q_CISS
for step in range(N_pasos):
    q_CISS = q_CISS_values[step]  # Actualizar q_CISS en cada paso
...
ax.set_title("Evolución de la polarización de espín")
...
ani.save('results/evolucion_espines.gif', writer='pillow')
